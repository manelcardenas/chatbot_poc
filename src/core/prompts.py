...
spending_prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            f"You are a helpful customer support assistant specializing in resolving customer inquiries related to their electricity bills. 
...
recommendation_prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            f"You are a helpful customer support assistant specializing in electricity plan recommendations. 
